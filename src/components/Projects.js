            ...
            <div className="repos row d-flex justify-content-center m-auto">
              {repos.map((repo) => {
               ...
               <div className="card m-3 d-flex flex-column justify-content-between" style={{width: '18rem',backgroundColor: 'var(--color-2)',border: 'none',margin: '10px',padding:'20px'}}>
                ...
                <p className='d-flex align-items-center' style={{color:'var(--color-3)',fontSize:'16px'}}><svg style={{marginRight:'8px',fill:'var(--color-3)'}} xmlns="http://www.w3.org/2000/svg" width="18" height="17" fill="#ffff00" class="bi bi-star-fill" viewBox="0 0 16 16">
